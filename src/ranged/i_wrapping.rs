        ...
        + Zero,
{
    ...
    fn wrapping_add(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_div(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_div_euclid(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_mul(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_neg(self) -> Self::Output { todo!() }

    fn wrapping_pow(self, _rhs: u32) -> Self::Output { todo!() }

    fn wrapping_rem(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_rem_euclid(self, _rhs: Self) -> Self::Output { todo!() }

    fn wrapping_shl(self, _rhs: u32) -> Self::Output { todo!() }

    fn wrapping_shr(self, _rhs: u32) -> Self::Output { todo!() }

    fn wrapping_sub(self, _rhs: Self) -> Self::Output { todo!() }
}
